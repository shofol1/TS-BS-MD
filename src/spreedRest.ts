...
//spreed
const myFriends = ["akash", "Shanto", "Sohan"];
const newestFriends = ["Zobayer", "Didar", "Jahid"];

myFriends.push(...newestFriends);
// console.log("🚀 ~ file: spreedRest.ts:33 ~ myFriends:", myFriends);
